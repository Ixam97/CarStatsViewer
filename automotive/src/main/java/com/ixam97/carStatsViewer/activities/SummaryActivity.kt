...
class SummaryActivity: Activity() {
    ...
    private fun setupConsumptionLayout() {
        ...
        summary_consumption_plot.dimensionRestriction = MainActivity.appPreferences.distanceUnit.asUnit((((tripData.traveledDistance * appPreferences.distanceUnit.toFactor()) / MainActivity.DISTANCE_TRIP_DIVIDER).toInt() + 1) * MainActivity.DISTANCE_TRIP_DIVIDER) + 1
